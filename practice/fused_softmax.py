...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_vals=['triton', 'torch', 'tutorial_softmax'],  # possible values for `line_arg``
        line_names=["Triton", "Torch", "Tutorial Softmax"],  # label name for the lines
...
def benchmark(M, N, provider):
    ...
    if provider == 'tutorial_softmax':
        ms = triton.testing.do_bench(lambda: tutorial_softmax(x))
